...
//* U8G2库链接
#define MN_U8G2_INC "u8g2/u8g2.h"

//* 显示参数配置
#define MN_HOR_RES             128
#define MN_VER_RES             64
...
#include "delay_stm32_cmsis_systick.h"
#define port_mn_delay(x)     delay_ms(x)

#include "debug_stm32_hal_hw_uart.h"
